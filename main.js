...
newTrial("testing_instructions",
    newText("On passe maintenant  la deuxime partie. Des images vous seront prsentes, prcdes d'une question. La question vous demandera d'identifier tous les lments qui peuvent tre dsigns par un mot donn dans la langue  laquelle vous venez d'tre expos, ou tous les lments qui ne peuvent pas tre dsigns par un mot donn. Slectionnez toutes les images qui correspondent  la demande, puis appuyez sur le bouton 'continuer'. Vous pouvez dslectionner une photo en cliquant  nouveau sur celle-ci. Les images slectionnes seront marques par un contour en gras. Si aucune des images ne peut tre dcrite par le mot donn, cochez la case 'aucune des images ci-dessus' et appuyez sur 'continuer'.")
